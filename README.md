...
Please also checkout [AutoGluon](https://github.com/autogluon/autogluon) if you have image classification or object detection need. We have built the [MultimodalPredictor](https://auto.gluon.ai/stable/tutorials/multimodal/index.html) with improved model zoo, including TIMM, Huggingface, MMDetection and more. With just a few lines of code, you can train and deploy high accuracy computer vision models for your application.
