    ...
    def __init__(self, multiplier=1.0, classes=1000, **kwargs):
        ...
        with self.name_scope():
            ...
            with self.features.name_scope():
                ...
                in_channels_group = [int(x *
                                         multiplier) for x in [32] +
                                     [16] +
                                     [24] *
                                     2 +
                                     [32] *
                                     ...
                                     [160] *
                                     3]
                channels_group = [int(x *
                                      multiplier) for x in [16] +
                                  [24] *
                                  2 +
                                  [32] *
                                  3 +
                ...
                last_channels = int(
                    1280 * multiplier) if multiplier > 1.0 else 1280
