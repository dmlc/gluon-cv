...
__all__ = ['resnet18_v1b_p1', 'resnet50_v1d_p1', 'resnet50_v1d_p2', 'resnet50_v1d_p3',
           'resnet50_v1d_p4', 'resnet101_v1d_p1', 'resnet101_v1d_p2'
           ]
    ...
    for key, layer in net._children.items():
        ...
        if isinstance(layer, nn.Conv2D):
            ...
            for param_name in ['weight']:
                param_shape = params_shapes[layer.name.replace(prefix, "resnetv1d") + "_" + param_name]
...
def resnet18_v1b_p1(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet50_v1d_p1(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet50_v1d_p2(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet50_v1d_p3(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet50_v1d_p4(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet101_v1d_p1(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
...
def resnet101_v1d_p2(pretrained=False, root='~/.mxnet/models', ctx=cpu(0), **kwargs):
