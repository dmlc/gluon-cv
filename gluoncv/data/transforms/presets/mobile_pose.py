...
__all__ = ['MobilePoseDefaultTrainTransform', 'MobilePoseDefaultValTransform']
...
class MobilePoseDefaultTrainTransform(object):
    ...
    def __init__(self, num_joints, joint_pairs, image_size=(256, 256), heatmap_size=(64, 64),
                 ...
                 **kwargs):
        from ....model_zoo.mobile_pose.pose_target import MobilePoseGaussianTargetGenerator
        self._target_generator = MobilePoseGaussianTargetGenerator(
...
class MobilePoseDefaultValTransform(object):
    """Default training transform for simple pose.
