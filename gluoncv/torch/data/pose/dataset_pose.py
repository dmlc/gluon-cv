...
from ..detection.detection_utils import check_metadata_consistency, read_image, filter_empty_instances, check_image_size, build_augmentation_v2
...
class DatasetMapperWithBasis(DatasetMapper):
    ...
    def __init__(self, cfg, is_train=True):
        ...
        self.augmentation = build_augmentation_v2(cfg, is_train)
