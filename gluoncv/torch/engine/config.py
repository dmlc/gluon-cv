...
# DIRECTPOSE Head
# ---------------------------------------------------------------------------- #
_C.CONFIG.DIRECTPOSE = CN()

# This is the number of foreground classes.
_C.CONFIG.DIRECTPOSE.NUM_CLASSES = 1
_C.CONFIG.DIRECTPOSE.NUM_KPTS = 17
_C.CONFIG.DIRECTPOSE.IN_FEATURES = ["p3", "p4", "p5", "p6", "p7"]
_C.CONFIG.DIRECTPOSE.FPN_STRIDES = [8, 16, 32, 64, 128]
_C.CONFIG.DIRECTPOSE.PRIOR_PROB = 0.01
_C.CONFIG.DIRECTPOSE.INFERENCE_TH_TRAIN = 0.05
_C.CONFIG.DIRECTPOSE.INFERENCE_TH_TEST = 0.05
_C.CONFIG.DIRECTPOSE.NMS_TH = 0.6
_C.CONFIG.DIRECTPOSE.PRE_NMS_TOPK_TRAIN = 1000
_C.CONFIG.DIRECTPOSE.PRE_NMS_TOPK_TEST = 1000
_C.CONFIG.DIRECTPOSE.POST_NMS_TOPK_TRAIN = 100
_C.CONFIG.DIRECTPOSE.POST_NMS_TOPK_TEST = 100
_C.CONFIG.DIRECTPOSE.TOP_LEVELS = 2
_C.CONFIG.DIRECTPOSE.NORM = "GN"  # Support GN or none
_C.CONFIG.DIRECTPOSE.USE_SCALE = True

# Multiply centerness before threshold
# This will affect the final performance by about 0.05 AP but save some time
_C.CONFIG.DIRECTPOSE.THRESH_WITH_CTR = False

# Focal loss parameters for i) Classification and ii) When using Binary Label as heatmap
_C.CONFIG.DIRECTPOSE.LOSS_ALPHA = 0.25
_C.CONFIG.DIRECTPOSE.LOSS_GAMMA = 2.0
_C.CONFIG.DIRECTPOSE.SIZES_OF_INTEREST = [64, 128, 256, 512]
_C.CONFIG.DIRECTPOSE.USE_RELU = True
_C.CONFIG.DIRECTPOSE.USE_DEFORMABLE = False

# the number of convolutions used in the cls and bbox tower
_C.CONFIG.DIRECTPOSE.NUM_CLS_CONVS = 4
_C.CONFIG.DIRECTPOSE.NUM_BOX_CONVS = 4
_C.CONFIG.DIRECTPOSE.NUM_KPT_CONVS = 4
_C.CONFIG.DIRECTPOSE.NUM_HMS_CONVS = 2
_C.CONFIG.DIRECTPOSE.NUM_SHARE_CONVS = 0
_C.CONFIG.DIRECTPOSE.CENTER_SAMPLE = True
_C.CONFIG.DIRECTPOSE.POS_RADIUS = 1.5
_C.CONFIG.DIRECTPOSE.LOC_LOSS_TYPE = 'giou'

_C.CONFIG.DIRECTPOSE.ENABLE_HM_BRANCH = True
_C.CONFIG.DIRECTPOSE.HM_OFFSET = False
_C.CONFIG.DIRECTPOSE.HM_CHANNELS = 128
_C.CONFIG.DIRECTPOSE.HM_LOSS_TYPE = 'focal'
_C.CONFIG.DIRECTPOSE.HM_LOSS_WEIGHT = 4.0
_C.CONFIG.DIRECTPOSE.HM_TYPE = 'Gaussian'
_C.CONFIG.DIRECTPOSE.HM_MSELOSS_BG_WEIGHT = 1.0      # When using MSE Loss on Gaussian heatmap
_C.CONFIG.DIRECTPOSE.HM_MSELOSS_WEIGHT = 1.0
_C.CONFIG.DIRECTPOSE.HM_FOCALLOSS_ALPHA = 2          # When using Focal Loss on Gaussian heatmap
_C.CONFIG.DIRECTPOSE.HM_FOCALLOSS_BETA = 4
_C.CONFIG.DIRECTPOSE.REFINE_KPT = False

_C.CONFIG.DIRECTPOSE.KPT_VIS = False
_C.CONFIG.DIRECTPOSE.LOSS_ON_LOCATOR = False
_C.CONFIG.DIRECTPOSE.KPT_L1_beta = 1/9

_C.CONFIG.DIRECTPOSE.ENABLE_BBOX_BRANCH = False
_C.CONFIG.DIRECTPOSE.YIELD_PROPOSAL = False
_C.CONFIG.DIRECTPOSE.SAMPLE_FEATURE = 'lower'
_C.CONFIG.DIRECTPOSE.KPALIGN_GROUPS = 9
_C.CONFIG.DIRECTPOSE.SEPERATE_CONV_FEATURE = True
_C.CONFIG.DIRECTPOSE.SEPERATE_CONV_CHANNEL = 64

_C.CONFIG.DIRECTPOSE.CLOSEKPT_NMS = False
_C.CONFIG.DIRECTPOSE.CENTER_BRANCH = 'cls'
