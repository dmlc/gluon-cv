...
import argparse
parser = argparse.ArgumentParser(description='Export gcv pretrained models using TVM')
parser.add_argument('--type', type=str, choices=['classify', 'detect'],
                    help='type of the model, image classification or object detection.')
