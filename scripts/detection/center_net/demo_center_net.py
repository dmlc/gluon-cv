...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default='center_net_resnet18_v1b_coco',
                        help="Network name")
...
if __name__ == '__main__':
    ...
    net.set_nms(-1, -1)  # by default do not use post-nms
    net.collect_params().reset_ctx(ctx = ctx)

    for image in image_list:
        ax = None
        x, img = presets.center_net.load_test(image, short=512)
