...
from gluoncv.data.transforms.presets.matrix_net import MatrixNetDefaultTrainTransform
from gluoncv.data.transforms.presets.matrix_net import MatrixNetDefaultValTransform, get_post_transform
...
def parse_args():
    parser = argparse.ArgumentParser(description='Train MatrixNet networks.')
...
def get_dataloader(net, train_dataset, val_dataset, data_shape, batch_size, num_workers, ctx):
    ...
    val_loader = gluon.data.DataLoader(
        val_dataset.transform(MatrixNetDefaultValTransform(width, height)),
...
if __name__ == '__main__':
    ...
    # network
    net_name = '_'.join(('matrix_net', args.network, args.dataset))
