...
def train(net, train_data, val_data, eval_metric, batch_size, ctx, args):
    ...
    rpn_box_loss = BalancedL1Loss(rho=args.rpn_smoothl1_rho)  # == BalancedL1Loss
    rcnn_cls_loss = mx.gluon.loss.SoftmaxCrossEntropyLoss()
    rcnn_box_loss = BalancedL1Loss(rho=args.rcnn_smoothl1_rho)  # == BalancedL1Loss
