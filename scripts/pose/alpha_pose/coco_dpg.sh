python train_alpha_pose.py --dataset coco \
    ...
    --lr 0.001 --wd 0.0 --lr-mode step --lr-decay-epoch 30,60 \
    --num-epochs 90 --batch-size 32 --num-gpus 4 -j 60 \
    --dtype float32 --warmup-epochs 0 --use-pretrained-base \
    --save-dir params_alpha_pose_resnet101_v1b_coco_dpg \
    --logging-file alpha_pose_resnet101_v1b_coco.log --log-interval 100 --flip-test \
    --addDPG --load-model final.params
