...
##################################################################
# Finally, to use both ``train_dataset`` and ``val_dataset`` for training,
# we can pass them without data transformations and the batch size into
# :py:class:`gluonvions.data.DetectionDataLoader`, see XXX for an example.
