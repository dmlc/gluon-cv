...
Please checkout :ref:`verify_pretrained.py <https://raw.githubusercontent.com/dmlc/gluon-cv/master/scripts/classification/imagenet/verify_pretrained.py>` for imagenet inference
...
.. image:: /_static/gluon_quantization_performance.png

   +--------------------------+----------+-----------+------------------+------------------+---------+---------------+-----------------+
   | Model                    | Dataset  | Batchsize | C5.18xlarge FP32 | C5.18xlarge INT8 | Speedup | FP32 Accuracy |  INT8 Accuracy  | 
   +==========================+==========+===========+==================+==================+=========+===============+=================+
