...
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+
| simple_pose_resnet18_v1b    | COCO Keypoint  | 128        | 323.64           | 825.77           | 2.55    | 66.3            | 65.9            |
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+
| simple_pose_resnet50_v1b    | COCO Keypoint  | 128        | 145.39           | 508.51           | 3.50    | 71.0            | 70.6            |
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+
| simple_pose_resnet50_v1d    | COCO Keypoint  | 128        | 85.41            | 503.16           | 5.89    | 71.6            | 71.4            |
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+
| simple_pose_resnet101_v1b   | COCO Keypoint  | 128        | 99.38            | 403.98           | 4.07    | 72.4            | 72.2            |
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+
| simple_pose_resnet101_v1d   | COCO Keypoint  | 128        | 67.04            | 400.34           | 5.97    | 73.0            | 72.7            |
+-----------------------------+----------------+------------+------------------+------------------+---------+-----------------+-----------------+


Quantized SSD models are evaluated with ``nms_thresh=0.45``, ``nms_topk=200``. For segmentation models, the accuracy metric is pixAcc, and for pose-estimation models, the accuracy metric is OKS AP.
