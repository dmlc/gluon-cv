...
################################################################
#
# `SiamRPN <http://openaccess.thecvf.com/content_cvpr_2018/papers/Li_High_Performance_Visual_CVPR_2018_paper.pdf>`_ is a widely adopted Single Object Tracking
#  method.
# The idea is straightforward: ,
# Send the template frame and detection frame to the siamese network, and get the score map and coordinate regression of the anchor through the RPN network and cross correlation layers.
...
# If you want to download youtube_bb dataset,you can You can follow it from the following link:
'''https://github.com/STVIR/pysot/tree/master/training_dataset/yt_bb'''
...
# 
lr_scheduler = gluoncv.utils.LRScheduler(mode='step', base_lr=0.005,
